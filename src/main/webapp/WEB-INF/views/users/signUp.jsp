...
<body class="auth">
	...
	<div id="auth-wrapper">
		<header id="auth-header">
			<i class="logo" onclick="parent.location.href='/ShotPlace'"></i>
		</header>
			...
			<form id="signUpForm" action="signUp" method="post" onsubmit="return check()">
				<div class= "biggroup">
					...
					<div id="form-password" class="form-group"> <!-- 비밀번호 -->
						<input type="password" name="password" value id="password"  maxlength="20" size="45" placeholder="비밀번호" style="border:none">
						<div class="form-error"></div>
					</div>
					...
					<div id="form-url" class="form-group">
						<input type="text" name="member_url" value id="url" maxlength="20" size="45" placeholder="개인 URL (영문)" style="border:none">
						<div class="form-error"></div>
					</div>
